...
#define  MQTT_TxData(x)       u4_TxData(x)                                  //串口2负责800C的数据发送

#define  PRODUCTKEY           "a1iiIDPG0uJ"                                 //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
#define  DEVICENAME           "D001"                                        //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
#define  DEVICESECRE          "9808fa138173d335f2fda294460e178e"            //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                           //设备秘钥长度
#define  S_TOPIC_NAME         "/sys/a1iiIDPG0uJ/D001/thing/service/property/set"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/sys/a1iiIDPG0uJ/D001/thing/event/property/post"    //需要发布的主题     
